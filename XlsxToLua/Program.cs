...
public class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        string[] excelFilePath = Utils.GetSupportedExcelFilePaths(AppValues.ExcelFolderPath, AppValues.IsExportIncludeSubfolder == true ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly).ToArray();
