    ...
    public class TableExportToLuaHelper
    {
        ...
        public static bool ExportTableToLua(TableInfo tableInfo, out string errorString)
        {
            ...
            bool isAddKeyToLuaTable = tableInfo.TableConfig != null &&
                                      ...
                                      tableInfo.TableConfig[AppValues.CONFIG_NAME_ADD_KEY_TO_LUA_TABLE].Count > 0 && "true".Equals(
                                          tableInfo.TableConfig[AppValues.CONFIG_NAME_ADD_KEY_TO_LUA_TABLE][0],
        ...
        /// </summary>
        private static void _GetIndexFieldData(StringBuilder content, Dictionary<object, object> parentDict, List<FieldInfo> tableValueField,
            ref int currentLevel, out string errorString)
        {
        ...
        private static string _GetOneFieldColumnInfo(FieldInfo fieldInfo, int level)
        {
            ...
            content.AppendFormat("{0}{1, -" + _FIELD_NAME_MIN_LENGTH + "}{2}{3, -" + _FIELD_DATA_TYPE_MIN_LENGTH + "}{4}{5}\n", _COMMENT_OUT_STRING,
                _GetFieldNameIndentation(level) + fieldInfo.FieldName, _DEFINE_INDENTATION_STRING, fieldInfo.DataTypeString,
                _DEFINE_INDENTATION_STRING, fieldInfo.Desc);
                    ...
                    if (fieldInfo.Data[row] == null)
                        ...
                        content.Append("\"")
                            .Append(((DateTime) (fieldInfo.Data[row])).ToString(fieldInfo
                                .ExtraParam[AppValues.TABLE_INFO_EXTRA_PARAM_KEY_DATE_TO_LUA_FORMAT].ToString())).Append("\"");
        ...
        private static void _AnalyzeJsonData(StringBuilder content, JsonData jsonData, int level)
        {
            ...
            else if (jsonData.IsObject == true)
            {
                ...
                List<string> childKeyNames = new List<string>((IEnumerable<string>) ((IDictionary) jsonData).Keys);
